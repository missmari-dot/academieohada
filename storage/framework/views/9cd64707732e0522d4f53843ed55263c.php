    ...
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus class="form-input">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-orange btn-full btn-lg">Se connecter</button>
        </form>
        ...
        <p class="auth-links">
            ...
            <a href="<?php echo e(route('rejoindre')); ?>">Rejoindre l'équipe</a>
        </p>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\academieohada-laravel\academieohada\resources\views/auth/connexion.blade.php ENDPATH**/ ?>