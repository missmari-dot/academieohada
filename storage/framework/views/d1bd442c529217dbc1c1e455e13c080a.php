...
<div class="table-wrapper">
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr class="<?php echo e(!$msg->lu ? 'row-unread' : ''); ?>">
                <td><strong><?php echo e($msg->prenom); ?> <?php echo e($msg->nom); ?></strong></td>
                <td><?php echo e(Str::limit($msg->sujet, 50)); ?></td>
                <td><?php echo e($msg->email); ?></td>
                <td><?php echo e($msg->lu ? '✅' : '🔴 Nouveau'); ?></td>
                <td><?php echo e($msg->created_at->format('d/m/Y H:i')); ?></td>
                <td><a href="<?php echo e(route('admin.messages.show', $msg)); ?>" class="btn btn-outline-navy btn-xs">Lire</a></td>
            </tr>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\academieohada-laravel\academieohada\resources\views/admin/messages/index.blade.php ENDPATH**/ ?>