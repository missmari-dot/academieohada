<?php $__env->startSection('title', 'Nos Services'); ?>
<?php $__env->startSection('description', 'Tous les services AcadémieOHADA : rédaction mémoires, correction, accompagnement, formation méthodologie.'); ?>
        ...
        <div class="services-detail-grid">
            <div class="service-detail-card">
                ...
                <div class="service-detail-body">
                    <?php $__currentLoopData = [['Choix du sujet','5 000'],['Problématique & hypothèses','8 000'],['Plan détaillé','5 000'],['Méthodologie','10 000'],['Introduction','25 000'],['1ère Partie','50 000'],['2ème Partie','50 000'],['Conclusion','10 000']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="service-detail-row">
                        <span><?php echo e($row[0]); ?></span>
                        <strong><?php echo e($row[1]); ?> FCFA</strong>
                    </div>
                ...
                <a href="<?php echo e(route('devis')); ?>?niveau=Master" class="btn btn-orange btn-full mt-2">Commander →</a>
            </div>
            ...
            <div class="service-detail-card">
                ...
                <div class="service-detail-body">
                    <?php $__currentLoopData = [['Choix du sujet','3 000'],['Problématique & hypothèses','5 000'],['Plan détaillé','3 000'],['Méthodologie','7 000'],['Introduction','15 000'],['1ère Partie','30 000'],['2ème Partie','30 000'],['Conclusion','7 000']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="service-detail-row">
                        <span><?php echo e($row[0]); ?></span>
                        <strong><?php echo e($row[1]); ?> FCFA</strong>
                    </div>
                ...
                <a href="<?php echo e(route('devis')); ?>?niveau=Licence" class="btn btn-orange btn-full mt-2">Commander →</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section section-alt" id="redaction">
    <div class="container">
        ...
        <div class="services-grid">
            ...
            <div class="service-card" id="<?php echo e($s[4]); ?>">
                <div class="service-icon"><?php echo e($s[0]); ?></div>
                <h3><?php echo e($s[1]); ?></h3>
                <p><?php echo e($s[2]); ?></p>
                <p class="service-price"><?php echo e($s[3]); ?></p>
                <a href="<?php echo e(route('devis')); ?>" class="service-link">Demander un devis →</a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="services-grid">
            ...
            <div class="service-card" id="<?php echo e($s[4]); ?>">
                ...
                <p><?php echo e($s[2]); ?></p>
                <p class="service-price"><?php echo e($s[3]); ?></p>
                <a href="<?php echo e(route('devis')); ?>" class="service-link">Réserver →</a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\academieohada-laravel\academieohada\resources\views/pages/services.blade.php ENDPATH**/ ?>