...
<head>
    ...
    <title>@yield('title', 'AcadémieRédactionOHADA') — Rédaction · Sénégal</title>
    <meta name="description" content="@yield('description', 'Service professionnel de rédaction de mémoires et accompagnement académique pour les étudiants des pays OHADA, UEMOA et CEDEAO.')">
...
<body>
    ...
    {{-- WhatsApp float --}}
    <a href="https://wa.me/{{ config('app.admin_whatsapp', '221775646246') }}?text={{ rawurlencode('Bonjour AcadémieRédactionOHADA, je souhaite des informations sur vos services.') }}"
