@extends('layouts.app')
@section('title','Ressources académiques')
@section('content')
    ...
    <div class="container">
        ...
        <div id="rediger" class="ressource-block">
            ...
            <div class="ressource-steps">
                @foreach([['1','Choisir son sujet','Optez pour un sujet précis, délimité, faisable dans les délais et en lien avec votre filière.'],['2','Faire la revue de littérature','Recensez les travaux existants sur votre sujet pour situer votre contribution.'],['3','Formuler la problématique','Posez la question centrale à laquelle votre mémoire va répondre.'],['4','Définir la méthodologie','Choisissez entre méthode qualitative, quantitative ou mixte selon votre sujet.'],['5','Rédiger et structurer','Introduction → Partie 1 → Partie 2 → Conclusion. Respectez les normes de votre établissement.'],['6','Réviser et corriger','Relisez plusieurs fois, faites corriger par un tiers, vérifiez les citations et la bibliographie.']] as $s)
                <div class="ressource-step">
                    <span class="step-circle">{{ $s[0] }}</span>
        ...
        <div id="faq" class="ressource-block">
            ...
            <div class="faq-list">
                ...
                <div class="faq-item-large">
                    <p class="faq-q-large"><strong>{{ $faq[0] }}</strong></p>
                    <p class="faq-a-large">{{ $faq[1] }}</p>
                </div>
                @endforeach
            </div>
        </div>
