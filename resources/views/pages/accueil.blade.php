    ...
    <div class="container">
        ...
        <div class="services-grid">
            ...
            <div class="service-card fade-in delay-1">
                ...
                <a href="{{ route('services') }}#powerpoint" class="btn btn-outline-navy btn-sm">En savoir plus →</a>
            </div>
            <div class="service-card fade-in delay-2">
                <div class="service-icon">📄</div>
                ...
                <p class="service-price">À partir de 5 000 FCFA</p>
                <a href="{{ route('services') }}#redaction" class="btn btn-outline-navy btn-sm">En savoir plus →</a>
            </div>
            <div class="service-card service-card-cta fade-in delay-3">
                ...
                <a href="{{ route('devis') }}" class="btn btn-orange">Obtenir mon devis →</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section section-alt why-us">
    <div class="container">
        ...
        <div class="guarantees-grid">
            ...
            <div class="guarantee-item fade-in" style="animation-delay: {{ 0.1 * $index }}s">
                <span class="guarantee-icon">{{ $g[0] }}</span>
                <div>
                    <strong>{{ $g[1] }}</strong>
                    <p>{{ $g[2] }}</p>
                </div>
...
<section class="section disciplines">
    <div class="container">
        ...
        <div class="disciplines-grid">
            @foreach(['Droit OHADA','Finance & Économie','Sciences Politiques','Informatique & SI','Marketing','Sociologie','Comptabilité','Lettres & Linguistique','Ressources Humaines','Santé & Médecine','Commerce international','Sciences de l\'éducation'] as $d)
...
<section class="section section-alt testimonials">
    <div class="container">
        ...
        <div class="testimonials-grid">
            ...
            <div class="testimonial-card fade-in" style="animation-delay: {{ 0.2 * $index }}s">
                <p class="testimonial-stars">{{ $t[3] }}</p>
                <p class="testimonial-text">"{{ $t[2] }}"</p>
                <div class="testimonial-author">
                    <div class="testimonial-avatar">{{ substr($t[0],0,1) }}</div>
                    <div>
                        <p class="testimonial-name">{{ $t[0] }}</p>
                        <p class="testimonial-role">{{ $t[1] }}</p>
                    </div>
                </div>
            </div>
            @endforeach
...
<section class="cta-section fade-in">
    <div class="container cta-inner">
        ...
        <div class="cta-actions fade-in delay-3">
            <a href="{{ route('devis') }}" class="btn btn-orange btn-lg">Demander un devis gratuit →</a>
